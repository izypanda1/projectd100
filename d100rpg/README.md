...
This system is a c-foundry-data-data-systems-boilerplate system that you can use as a starting point for building your own custom systems. It's similar to Simple World-building, but has examples of creating attributes in code rather than dynamically through the UI.

## Usage

There are two ways to get started: using the d100rpg system generator command or manually renaming and updating files.
...
> **Python Generator**
> 
> If you would rather use Python than node, there’s an excellent Python-based generator created by Cussa at https://github.com/Cussa/fvtt-c-foundry-data-data-systems-boilerplate-initializator. Give it a shot!
...
Before installing this system, you should rename any files that have `c-foundry-data-data-systems-boilerplate` in their filename to use whatever machine-safe name your system needs, such as `adnd2e` if you were building a system for 2nd edition Advanced Dungeons & Dragons. In addition, you should search through the files for `c-foundry-data-data-systems-boilerplate` and `d100rpg` and do the same for those, replacing them with appropriate names for your system.
...
Head over to the [Vue3d100rpg System](https://gitlab.com/asacolips-projects/foundry-mods/vue3c-foundry-data-data-systems-boilerplate) repo if you're interested in using Vue!
...
![image](http://mattsmith.in/images/c-foundry-data-data-systems-boilerplate.png)
